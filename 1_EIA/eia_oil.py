...
#         <td >&nbsp;</td>
#         <td style="background-color: {color_based_on_value(to_forecast_api_value(investing_output_result['API Weekly Crude Oil Stock']))};">&nbsp;{to_str_forecast_api_value(investing_output_result['API Weekly Crude Oil Stock'])}</td>
#         <td >&nbsp;</td>
